...
public class UI2 {
    private ui_main ui;
    public UI2(String path, user myuser) {
        this.ui = new ui_main(path, myuser);
    }
    public void load_ui() {
        this.ui.load_ui();
    }
...
class ui_main {
    ...
    String[][][] ui_fns = {
    		...
    		{{"Project_Details"},{"List_Projects","Get_Enquiries","Send_Application"}},
    		{{"Project_Enquiries"},{"Project_Details","Submit_Enquiry"}}
    }; 
    ...
    //
    String[][][] next_ui = {
    		{{"Project_List"},{"Project_Details"}}, //key, values[]
    		{{"Project_Details"},{"Project_List","Project_Enquiries",""}},
    		{{"Project_Enquiries"},{"Project_List","NIL"}}
    };
    ...
    public ui_main(String filepath, user currentUser) {
