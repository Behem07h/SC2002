...
public class RegistrationManager{
    ...
    /**
     * Assigns an officer to the project when their registration is approved.
     *
     * @param reg The registration containing the officer to assign
     * @param proMan The ProjectManager instance to use for assigning
     */
